...
//{
//	FILE* pFile = fopen(strfileName, "rb");  // 以二进制方式打开文件
//	if (pFile == NULL)
//	{
//		cout << "打开文件失败！" << endl;
//		return NULL;
//	}
//	memset(data_buf0, 0, sizeof(data_buf0));
...
//	cur_dev = devs;
//	for (int i = 0; cur_dev != NULL; i++, cur_dev = cur_dev->next) 
//	{
